...
BOOT_KERNEL_MODULES := $(strip $(shell cat $(LOCAL_PATH)/modules.load.recovery $(LOCAL_PATH)/modules.include.vendor_ramdisk))
SYSTEM_KERNEL_MODULES := $(strip $(shell cat $(LOCAL_PATH)/modules.include.system_dlkm))
